      ...
      <main id='car-content'>
        <div>
          <div id='carouselExampleAutoplaying' className='carousel carousel-slide' data-bs-ride='carousel'>
            ...
            <div className='carousel-inner' id='car-inner-content'>
              <div className='carousel-item active'>
                <img src='/imgs/ford1.png' className='d-block mx-auto w-100 img-fluid' alt='...' />
              </div>
              <div className='carousel-item'>
                <img src='/imgs/ford2.png' className='d-block mx-auto w-100 img-fluid' alt='...'/>
              </div>
              <div className='carousel-item'>
                <img src='/imgs/ford3.png' className='d-block mx-auto w-100 img-fluid' alt='...'/>
              </div>
            </div>
